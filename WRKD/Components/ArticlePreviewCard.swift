//
//  ArticleLargeViewReDesign.swift
//  WRKD
//
//  Created by Davaughn Williams on 11/21/25.
//
        ...
        VStack(spacing: 0) {
            ...
            .overlay(alignment: .bottom) {
                VStack(alignment: .leading) {
                    ...
                    Text(article.title)
                        .font(ArticleStyleConstants.titleFontSmall)
                    ...
                    HStack {
                        Text(article.timeAgo)
                            .font(ArticleStyleConstants.subtitleFontSmall)
...
#Preview {
    ...
    ArticlePreviewCard(article: sampleArticle)
}
